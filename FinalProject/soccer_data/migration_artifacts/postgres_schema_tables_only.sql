...
CREATE TABLE "soccer_proj"."Country" (
    ...
    CONSTRAINT "Country_uq_1" UNIQUE ("name")
);
...
CREATE TABLE "soccer_proj"."League" (
    ...
    CONSTRAINT "League_uq_1" UNIQUE ("name")
);
...
CREATE TABLE "soccer_proj"."Match_tbl" (
    ...
    CONSTRAINT "Match_tbl_uq_1" UNIQUE ("match_api_id")
);
...
CREATE TABLE "soccer_proj"."Player" (
    ...
    CONSTRAINT "Player_uq_1" UNIQUE ("player_fifa_api_id")
);
...
CREATE TABLE "soccer_proj"."Team" (
    ...
    CONSTRAINT "Team_uq_0" UNIQUE ("team_api_id")
);
